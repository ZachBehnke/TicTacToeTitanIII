...
public class TicTacButton extends ImageButton
{
	...
	public void initialize()
	{
		setOnTouchListener(new OnTouchListener()
		{
			...
			{
				// if (!is_assigned && getActivity().game_in_progress)
	...
	{
		if (getActivity().state == State.circle)
			setBackgroundResource(R.drawable.btn_o);
		if (getActivity().state == State.cross)
			setBackgroundResource(R.drawable.btn_x);
